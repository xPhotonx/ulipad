...
#
#   $Id: LexerBase.py 1457 2006-08-23 02:12:12Z limodou $
...
#        font = wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT)
        ...
        linesize = x.default.get('editor_linesize', 10)
        ...
        self.addSyntaxItem('linenumber',    tr('Line numbers'),             wx.stc.STC_STYLE_LINENUMBER,    self.STC_STYLE_LINENUMBER % self.defaultfaces)
