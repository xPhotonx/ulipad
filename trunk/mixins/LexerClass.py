...
"""
    ...
    def initSyntaxItems(self):
        ...
        self.addSyntaxItem('hj_commentline',            'Javascript - commentline',             wx.stc.STC_HJ_COMMENTLINE,              self.STE_STYLE_COMMENT),
        self.addSyntaxItem('hj_commentdoc',             'Javascript - commentdoc',              wx.stc.STC_HJ_COMMENTDOC,               self.STE_STYLE_COMMENT),
        ...
        self.addSyntaxItem('hja_commentline',           'ASP Javascript - commentline',         wx.stc.STC_HJA_COMMENTLINE,             self.STE_STYLE_COMMENT),
        self.addSyntaxItem('hja_commentdoc',            'ASP Javascript - commentdoc',          wx.stc.STC_HJA_COMMENTDOC,              self.STE_STYLE_COMMENT),
        ...
        self.addSyntaxItem('hb_commentline',            'VBScript - commentline',               wx.stc.STC_HB_COMMENTLINE,              self.STE_STYLE_COMMENT),
        ...
        self.addSyntaxItem('hba_commentline',           'ASP VBScript - commentline',           wx.stc.STC_HBA_COMMENTLINE,             self.STE_STYLE_COMMENT),
        ...
        self.addSyntaxItem('hp_commentline',            'Python - commentline',                 wx.stc.STC_HP_COMMENTLINE,              self.STE_STYLE_COMMENT),
        ...
        self.addSyntaxItem('hpa_commentline',           'ASP Python - commentline',             wx.stc.STC_HPA_COMMENTLINE,             self.STE_STYLE_COMMENT),
        ...
        self.addSyntaxItem('hphp_complex_variable',     'PHP - complex variable',               wx.stc.STC_HPHP_COMPLEX_VARIABLE,       self.STE_STYLE_VALUE),
        self.addSyntaxItem('hphp_comment',              'PHP - comment',                        wx.stc.STC_HPHP_COMMENT,                self.STE_STYLE_COMMENT),
        self.addSyntaxItem('hphp_commentline',          'PHP - comment line',                   wx.stc.STC_HPHP_COMMENTLINE,            self.STE_STYLE_COMMENT),
...
"""
    ...
    def initSyntaxItems(self):
        ...
        self.addSyntaxItem('tag',               'Tag',                  self.syl_tag,           'fore:#15852B')
        self.addSyntaxItem('attribute',         'Attribute Name',       self.syl_attrname,      'fore:#F0804F')
        self.addSyntaxItem('attrvalue',         'Attribute Value',      self.syl_attrvalue,     'fore:#156EB2')
