...
def add_mainframe_menu(menulist):
    menulist.extend([ ('IDM_EDIT',
        ...
        [
            ...
            (140, 'IDM_EDIT_FORMAT_INDENT', tr('Increase Indent')+'\tTab', wx.ITEM_NORMAL, 'OnEditFormatIndent', tr('Increases the indentation of current line or selected block')),
            (150, 'IDM_EDIT_FORMAT_UNINDENT', tr('Decrease Indent')+'\tShift+Tab', wx.ITEM_NORMAL, 'OnEditFormatUnindent', tr('Decreases the indentation of current line or selected block')),
            (160, '', '-', wx.ITEM_SEPARATOR, None, ''),
