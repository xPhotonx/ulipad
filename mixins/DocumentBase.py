...
#
#	$Id: DocumentBase.py 176 2005-11-22 02:46:37Z limodou $
...
class DocumentBase:
	...
	def openfile(self, filename='', encoding='', delay=False, defaulttext=''):
		self.filename = filename
	...
	def isMe(self, filename, documenttype = 'edit'):
		if wx.Platform == '__WXMSW__':
			flag = filename.lower() == self.filename.lower()
		else:
	...
	def canopenfile(self, filename):
		return self.canopenfileflag and not self.isModified()
