...
#
#	$Id: FindInFiles.py 93 2005-10-11 02:51:02Z limodou $
...
class FindInFiles(wx.Dialog):
	def __init__(self, parent, pref):
		...
		self.btnBrow = wx.Button(self, self.ID_BROW, tr("Add Path"), size=(80, 22))
	...
	def OpenFound(self, e):
		...
		self.mainframe.document.GotoLine(line-1)
