...
#
#   $Id: DirBrowser.py 100 2005-10-11 06:34:48Z limodou $
...
class DirBrowser(wx.Panel, Mixin.Mixin):
    ...
    popmenulist = [ (None,
        [
            ...
            (130, 'IDPM_ADDFILE', tr('Add Sub Directory'), wx.ITEM_NORMAL, 'OnAddSubDir', ''),
            (140, 'IDPM_ADDPATH', tr('Add File'), wx.ITEM_NORMAL, 'OnAddFile', ''),
        ...
        [
            ...
            (120, 'IDPM_ADD_DIRS', tr('(empty)'), wx.ITEM_NORMAL, '', ''),
        ]),
    ]
    ...
    def __init__(self, parent, mainframe):
        ...
        self.popupmenu = makemenu.makepopmenu(self, DirBrowser.popmenulist)
    ...
    def addpathnodes(self, path, node):
        ...
        for x, dirflag in dirs:
            self.addnode(node, path, x, self.close_image, self.open_image, self.getid())
    ...
    def OnRClick(self, event):
        ...
        self.tree.PopupMenu(self.popupmenu, event.GetPosition())
    ...
    def OnDelete(self, event):
        ...
        if dlg.ShowModal() == wx.ID_YES and os.path.exists(filename):
            if os.path.isdir(filename):
                try:
                    os.rmdir(filename)
                except:
