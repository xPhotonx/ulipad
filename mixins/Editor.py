...
#
#   $Id: Editor.py 1730 2006-11-21 13:46:26Z limodou $
...
#       wxSTC_CMD_WORDPARTRIGHTEXTEND: Use 2393 Move to the next change in capitalisation extending selection to new caret position.
    ...
    def BeginUndoAction(self):
        self.dont_analysis = True
        wx.stc.StyledTextCtrl.BeginUndoAction(self)
        
    def EndUndoAction(self):
        wx.stc.StyledTextCtrl.EndUndoAction(self)
        self.dont_analysis = False
        self.callplugin('editor', 'on_analysis', self)
