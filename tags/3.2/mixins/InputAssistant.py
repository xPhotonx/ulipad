...
class InputAssistant(Mixin.Mixin):
    ...
    def get_assistant(self, filename):
        ...
        obj.autostring = self.install_keylist(obj.ini.ordereditems(obj.ini.autostring), False)
        #autostring_append is used to append
        obj.autostring_append = self.install_keylist(obj.ini.ordereditems(obj.ini.autostring_append), False)
        #autore is used to replace
        obj.autore = self.install_keylist(obj.ini.ordereditems(obj.ini.autore), True)
        #autore_replace is used to append
        obj.autore_append = self.install_keylist(obj.ini.ordereditems(obj.ini.autore_append), True)
