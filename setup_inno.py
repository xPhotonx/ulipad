...
includes = ["modules.EasyGui.*", "modules.meteor.*"]
options = {
	"py2exe":
	{
		"compressed": 1,
...
class InnoScript:
    ...
    def create(self, pathname="dist\\newedit.iss"):
        ...
        print >> ofi, "AppPublisherURL=http://newedit.tigris.org"
        print >> ofi, "AppSupportURL=http://www.donews.net/limodou"
        print >> ofi, "AppUpdatesURL=http://newedit.tigris.org"
...
setup(
	...
	data_files = [
		('images', glob.glob('images/*gif') + glob.glob('images/*jpg')),
